...
<head>
    ...
    <script src="{{ asset('js/backend/function.js') }}" ></script>
    <style>
        body {
...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 text-gray-900 dark:text-white">
        ...
        <form class="job-results-aside-grid" id="filter-form">
            ...
            <button type="submit" class="btn btn-primary" onclick="load('{{ route('categories.search') }}', 'form:#filter-form', 'category_id={{ $id }}'); return false;">Apply Filters</button>
        </form>
